#include<stdio.h>
#include<stdbool.h>
long long n,t[9][1009],odp[1009]={0};	//x1,y1,x2,y2,x3,y3,vxy,vy
bool koliz(long long a,long long b);
bool zawie(long long a,long long b);
bool zawiera(long long a,long long b);
...
bool koliz (long long a, long long b){
	//printf("\n%d %d",a,b);
	if(przecina(t[0][a],t[1][a],t[0][a]+t[6][a]-t[6][b],t[1][a]+t[7][a]-t[7][b],t[0][b],t[1][b],t[2][b],t[3][b]))	//punk,predkosc, odcinek - 6 razy
		return 1;
	...
	if(przecina(t[4][a],t[5][a],t[4][a]+t[6][a]-t[6][b],t[5][a]+t[7][a]-t[7][b],t[0][b],t[1][b],t[4][b],t[5][b]))
		return 1;
	if(przecina(t[0][a],t[1][a],t[0][a]+t[6][a]-t[6][b],t[1][a]+t[7][a]-t[7][b],t[2][b],t[3][b],t[4][b],t[5][b]))
		return 1;
	if(przecina(t[2][a],t[3][a],t[2][a]+t[6][a]-t[6][b],t[3][a]+t[7][a]-t[7][b],t[2][b],t[3][b],t[4][b],t[5][b]))
		return 1;
	if(przecina(t[4][a],t[5][a],t[4][a]+t[6][a]-t[6][b],t[5][a]+t[7][a]-t[7][b],t[2][b],t[3][b],t[4][b],t[5][b]))
		return 1;
	//printf("HMM");
	//Teraz dla  2 trojkat <3
	if(przecina(t[0][b],t[1][b],t[0][b]+t[6][b]-t[6][a],t[1][b]+t[7][b]-t[7][a],t[0][a],t[1][a],t[2][a],t[3][a]))	//punk,predkosc, odcinek - 6 razy
		return 1;
	...
	if(przecina(t[4][b],t[5][b],t[4][b]+t[6][b]-t[6][a],t[5][b]+t[7][b]-t[7][a],t[0][a],t[1][a],t[4][a],t[5][a]))
		return 1;
	if(przecina(t[0][b],t[1][b],t[0][b]+t[6][b]-t[6][a],t[1][b]+t[7][b]-t[7][a],t[2][a],t[3][a],t[4][a],t[5][a]))
		return 1;
	if(przecina(t[2][b],t[3][b],t[2][b]+t[6][b]-t[6][a],t[3][b]+t[7][b]-t[7][a],t[2][a],t[3][a],t[4][a],t[5][a]))
		return 1;
	if(przecina(t[4][b],t[5][b],t[4][b]+t[6][b]-t[6][a],t[5][b]+t[7][b]-t[7][a],t[2][a],t[3][a],t[4][a],t[5][a]))
		return 1;
	//printf("AHA");
	return 0;
}
...
bool zawiera(long long a,long long b){
	...
	zm2=(c1-b1)*(aa2-b2)-(aa1-b1)*(c2-b2);
	zm3=(c1-b1)*(bb2-b2)-(bb1-b1)*(c2-b2);
	zm4=(c1-b1)*(cc2-b2)-(cc1-b1)*(c2-b2);
	if(!(zm1<0 && zm2<0 && zm3<0 && zm4<0) && !(zm1>0 && zm2>0 && zm3>0 && zm4>0))
		return 0;
	return 1;
}
