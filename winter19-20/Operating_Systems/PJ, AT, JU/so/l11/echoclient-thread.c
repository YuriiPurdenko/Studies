...
int main(int argc, char **argv) {
  ...
  /*  It is impossible to implement it in similar manner as wait does 
  (wait for signal and then call wait), because signals are delivered to processes, 
  so it is undefined which thread will process the signal. */
